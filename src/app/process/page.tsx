            ...
            <div>
              ...
              <div className="mt-[6px] xl:max-w-[780px] 2xl:max-w-[996px] mx-auto">
                <div className="text-sm text-grey-20 leading-[21px] font-medium text-center xl:text-base xl:leading-6 2xl:text-lg 2xl:leading-[27px]">
                  ...
                  platform and access the resources you need to achieve your
                      ...
                      <div>
                        ...
                        <div className="mt-4 xl:mt-5">
                          <div className="text-grey-30 text-sm font-medium leading-[21px] xl:text-base xl:leading-6 2xl:text-lg 2xl:leading-[27px]">
                            We start by scheduling an initial consultation,
                            either in person or through a convenient online
                            meeting. During this session, we will discuss your
                            health history, lifestyle, goals, and any specific
                      ...
                      <div>
                        ...
                        <div className="mt-4 xl:mt-5">
                          <div className="text-grey-30 text-sm font-medium leading-[21px] xl:text-base xl:leading-6 2xl:text-lg 2xl:leading-[27px]">
                            ...
                            nutritional needs and create a personalized plan
                      ...
                      <div>
                        ...
                        <div className="mt-4 xl:mt-5">
                          <div className="text-grey-30 text-sm font-medium leading-[21px] xl:text-base xl:leading-6 2xl:text-lg 2xl:leading-[27px]">
                            ...
                            personalized nutrition plan that takes into account
                            your dietary preferences, lifestyle, and health
                            goals. This plan will provide you with clear
                            guidelines on what to eat, portion sizes, and meal
                            timing.
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="rounded-[10px] bg-green-95 border-solid border-[1px] border-green-90 relative h-full">
                    <div className="p-[30px] xl:p-10 2xl:p-[50px]">
                      <div>
                        ...
                        <div className="mt-4 xl:mt-5">
                          <div className="text-grey-30 text-sm font-medium leading-[21px] xl:text-base xl:leading-6 2xl:text-lg 2xl:leading-[27px]">
                            To make your journey easier, we will provide you
                            with a variety of delicious and nutritious meal
                            options, along with recipes that align with your
                            personalized nutrition plan.
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="rounded-[10px] bg-green-95 border-solid border-[1px] border-green-90 relative h-full">
                    <div className="p-[30px] xl:p-10 2xl:p-[50px]">
                      <div>
                        ...
                        <div className="mt-4 xl:mt-5">
                          <div className="text-grey-30 text-sm font-medium leading-[21px] xl:text-base xl:leading-6 2xl:text-lg 2xl:leading-[27px]">
                            Throughout your journey, our team of nutrition
                            experts will be there to provide ongoing support,
                            answer your questions, and offer guidance. We
                            believe in the power of continuous encouragement to
                            help you stay motivated and achieve long-term
                            success.
                          </div>
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="mt-4 xl:mt-5">
                          <div className="text-grey-30 text-sm font-medium leading-[21px] xl:text-base xl:leading-6 2xl:text-lg 2xl:leading-[27px]">
                            ...
                            user-friendly mobile app or website tools. You can
                            log your meals, monitor your weight, and track your
                            physical activity, allowing you to have a clear
                            picture of your progress and make any necessary
                            adjustments.
                          </div>
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="mt-4 xl:mt-5">
                          <div className="text-grey-30 text-sm font-medium leading-[21px] xl:text-base xl:leading-6 2xl:text-lg 2xl:leading-[27px]">
                            ...
                            progress, address any concerns, and make any
                            necessary adjustments to your nutrition plan. Our
                            goal is to ensure that you are consistently moving
                      ...
                      <div>
                        ...
                        <div className="mt-4 xl:mt-5">
                          <div className="text-grey-30 text-sm font-medium leading-[21px] xl:text-base xl:leading-6 2xl:text-lg 2xl:leading-[27px]">
                            ...
                            enhance your understanding of nutrition and empower
                            you to make informed choices for a healthier
                            lifestyle.
                          </div>
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="mt-4 xl:mt-5">
                          <div className="text-grey-30 text-sm font-medium leading-[21px] xl:text-base xl:leading-6 2xl:text-lg 2xl:leading-[27px]">
                            ...
                            will fine-tune and make adjustments to your
                            nutrition plan to ensure that it continues to align
                      ...
                      <div>
                        ...
                        <div className="mt-4 xl:mt-5">
                          <div className="text-grey-30 text-sm font-medium leading-[21px] xl:text-base xl:leading-6 2xl:text-lg 2xl:leading-[27px]">
                            ...
                            lifestyle habits that will support your long-term
                            health and wellness. We will equip you with the
                            knowledge and skills to maintain your progress even
